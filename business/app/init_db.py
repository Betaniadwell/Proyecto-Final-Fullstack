...
cur.execute('''CREATE TABLE IF NOT EXISTS oficina_ventas (id serial PRIMARY KEY, nombre varchar (50) , fecha_ing date , zona varchar (30), total_ventas integer, comisiones integer) ''')
